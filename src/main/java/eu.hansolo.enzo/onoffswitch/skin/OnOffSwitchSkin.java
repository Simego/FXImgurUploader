...
public class OnOffSwitchSkin extends SkinBase<OnOffSwitch> implements Skin<OnOffSwitch> {
    private static final double PREFERRED_WIDTH  = 56;
    ...
    private void initGraphics() {
        Font.loadFont(getClass().getResourceAsStream("/eu/hansolo/enzo/fonts/opensans-semibold.ttf"), (0.4 * PREFERRED_HEIGHT)); // "OpenSans"
        font = Font.font("Open Sans", 0.4 * PREFERRED_HEIGHT);

        background = new Region();
        background.getStyleClass().setAll("background");
        background.setStyle("-switch-color: " + Util.colorToCss((Color) getSkinnable().getSwitchColor()) + ";");

        selectedText = new Text("On ");
        ...
        selectedText.setSmooth(true);
        selectedText.setTextAlignment(TextAlignment.LEFT);

        deselectedText = new Text(" Off");
        ...
        deselectedText.setSmooth(true);
        deselectedText.setTextAlignment(TextAlignment.RIGHT);
